...
__declspec(dllexport) uint8_t GB_read_memory(GB_gameboy_t *gb, uint16_t addr)
{
...
__declspec(dllexport) void GB_write_memory(GB_gameboy_t *gb, uint16_t addr, uint8_t value) {
    GB_ASSERT_NOT_RUNNING_OTHER_THREAD(gb)
